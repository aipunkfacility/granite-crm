...
| `filters` | TEXT | JSON-фильтр для выборки получателей |
...
| `a3f1b2c4d5e6` | 2026-04-10 | `drop_pipeline_runs` — удаление мёртвой таблицы pipeline_runs |
| `025a08dcc789` | 2026-04-11 | `add_crm_tables` — 6 CRM таблиц (contacts, touches, templates, email_logs, tasks, campaigns) |
