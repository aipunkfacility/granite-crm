...
Плагин [superpowers](https://github.com/obra/superpowers) добавлен в OpenCode.

**Установка:** `opencode.json` проекта содержит:
...
**Активация:** использовать нативный `skill` инструмент OpenCode для загрузки скиллов.

**Antigravity (Workspace Skills):**
В этой IDE фреймворк установлен как набор локальных скиллов в `.agents/skills/`. Они подгружаются автоматически и управляются правилами в `GEMINI.md`.
...
| [**Superpowers**](https://github.com/obra/superpowers) | Библиотека дисциплинирующих навыков (TDD, Systematic Debugging, Planning). | **Установлено** в `.agents/skills/` |

---

## 🛡️ Использование Superpowers
